...
const val REQUEST_CODE_PHOTO = 69
class MeetActivity : AppCompatActivity(), MeetCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.example.meetflix.R.layout.activity_main)
                ...
                when (tab) {
                    profileTab -> {
                        if (profileFragment == null) {
                            ...
                            profileFragment!!.setCallback(this@MeetActivity)
                        }
                    ...
                    swipeTab -> {
                        if (swipeFragment == null) {
                            ...
                            swipeFragment!!.setCallback(this@MeetActivity)
                        }
                    ...
                    matchesTab -> {
                        if (matchesFragment == null) {
                            ...
                            matchesFragment!!.setCallback(this@MeetActivity)
                        }
    ...
    companion object{
        fun newIntent(context: Context?) = Intent(context, MeetActivity::class.java)
    }
