...
import com.example.meetflix.Chat
import com.example.meetflix.R
import com.example.meetflix.User
import com.example.meetflix.activities.MeetCallback
...
class MatchesFragment : Fragment() {
    ...
    private var callback: MeetCallback? = null

    private val chatsAdapter = ChatsAdapter(ArrayList())

    fun setCallback(callback: MeetCallback) {
